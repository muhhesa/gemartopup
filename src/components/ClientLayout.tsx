    ...
    <footer className="main-footer">
      <div className="container footer-top">
        <div className="footer-col brand-col">
          ...
          <div className="footer-contact">
            ...
            <div className="contact-item">
               <span>✉️</span> hi@gemartopup.com
            </div>
            <div className="contact-item">
               <span>📱</span> +6281234567890
            </div>
          </div>
        </div>
        ...
        <div className="footer-col action-col">
          ...
          <h4>{t("footer.registered")}</h4>
          <div className="links-col">
            <Link href="#">PSE Kominfo</Link>
            <Link href="#">Pangkalan Data Kekayaan Intelektual</Link>
          </div>
        </div>
      </div>
    ...
    <LanguageProvider>
      <div className="app-layout">
        ...
        <div className="main-wrapper">
          ...
          <a href="https://wa.me/6281234567890" target="_blank" rel="noreferrer" className="wa-fab no-print" title="Chat Admin via WhatsApp">
